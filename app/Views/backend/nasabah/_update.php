<div class="modal fade modal-insert" id="modal-update" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog modal-xl">
        <div class="modal-content">
            ...
            <form action="<?= route_to('Nasabah::update'); ?>" id="form-update" method="post">
                <?= csrf_field() ?>
                ...
                <div class="modal-body">
                    <div class="row">
                        ...
                        <div class="mb-3 col-md-6">
                            ...
                            <input type="text" id="nama_lengkap" name="nama_lengkap" value="<?= old('nama_lengkap'); ?>" class="form-control <?= validation_show_error('nama_lengkap') ? 'is-invalid' : ''; ?>">
                        ...
                        <div class="mb-3 col-md-6">
                            ...
                            <input type="text" id="panggilan" name="panggilan" value="<?= old('panggilan'); ?>" class="form-control <?= validation_show_error('panggilan') ? 'is-invalid' : ''; ?>">
                        ...
                        <div class="mb-3 col-md-6">
                            ...
                            <input type="text" id="tempat_lahir" name="tempat_lahir" value="<?= old('tempat_lahir'); ?>" class="form-control <?= validation_show_error('tempat_lahir') ? 'is-invalid' : ''; ?>">
                        ...
                        <div class="mb-3 col-md-6">
                            ...
                            <input type="date" id="tanggal_lahir" name="tanggal_lahir" value="<?= old('tanggal_lahir'); ?>" class="form-control <?= validation_show_error('tanggal_lahir') ? 'is-invalid' : ''; ?>" onclick="this.showPicker()">
                        ...
                        <div class="mb-3 col-md-6">
                            ...
                            <input type="text" id="no_telp1" name="no_telp1" value="<?= old('no_telp1'); ?>" class="form-control telp <?= validation_show_error('no_telp1') ? 'is-invalid' : ''; ?>">
                        ...
                        <div class="mb-3 col-md-6">
                            ...
                            <input type="text" id="no_wa" name="no_wa" value="<?= old('no_wa'); ?>" class="form-control telp <?= validation_show_error('no_wa') ? 'is-invalid' : ''; ?>">
                        ...
                        <div class="mb-3 col-md-6">
                            ...
                            <input type="text" id="no_telp2" name="no_telp2" value="<?= old('no_telp2'); ?>" class="form-control telp <?= validation_show_error('no_telp2') ? 'is-invalid' : ''; ?>">
                        ...
                        <div class="mb-3 col-12">
                            ...
                            <input type="email" id="email" name="email" value="<?= old('email'); ?>" class="form-control <?= validation_show_error('email') ? 'is-invalid' : ''; ?>">
